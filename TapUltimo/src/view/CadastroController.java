...
public class CadastroController {
	...
	private void inicializaTbl() {
		...
		colMat.setCellValueFactory(cellData -> cellData.getValue().matProperty().get()
		?new SimpleStringProperty("X")
		:new SimpleStringProperty(""));
		
		colVesp.setCellValueFactory(cellData -> cellData.getValue().vesProperty().get()
		?new SimpleStringProperty("X")
		:new SimpleStringProperty(""));
		
		colNot.setCellValueFactory(cellData -> cellData.getValue().notProperty().get()
		?new SimpleStringProperty("X")
		:new SimpleStringProperty(""));
	}
